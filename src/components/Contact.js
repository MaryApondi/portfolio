                     ...
                     <section className="contact-div">
                        <div className="Address">
                         ...
                         <div className="myform">
                             <div className = "primary-email"><a href="mailto:apondimary@outlook.com"><FontAwesomeIcon icon={faMicrosoft} />&nbsp;Outlook</a></div>
                             <div className = "secondary-email"><a href="mailto:apondimary457@gmail.com"><FontAwesomeIcon icon={faGoogle} />&nbsp;Gmail</a></div>
                             <div className = "phone"><a href="tel:+254742225355"><FontAwesomeIcon icon={faPhone} />&nbsp;work</a></div>
                             <div className = "phone"><a href="tel:+254742225355"><FontAwesomeIcon icon={faMobile} />&nbsp;cell</a></div>
                             <div className = "linkedin"><a href="https://linkedin.com/in/MaryApondi" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faLinkedinIn} />&nbsp;linkedIn</a></div>
                             <div className = "github"><a href="https://github.com/MaryApondi" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faGithub} />&nbsp;github</a></div>
                             <div className = "skype"><a href="skype:live:MaryApondi?call"><FontAwesomeIcon icon={faSkype} />&nbsp;skype</a></div>
                             <div className = "slack"><a href = "https://slack.com"><FontAwesomeIcon icon ={faSlack} />&nbsp;slack</a></div>
                             <div className="medium"><a href="https://medium.com/MaryApondi" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faMediumM} />&nbsp;Medium</a></div>
                             <div className="quora"><a href="https://www.quora.com/profile/Mary-Apondi-2" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faQuora} />&nbsp;Quora</a></div>
                             <div className = "twitter"><a href="https://twitter.com/MaryApondi15" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faTwitter} />&nbsp;twitter</a></div>
                             <div className = "facebook"><a href="https://www.facebook.com/MaryApondi.14" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faFacebookF} />&nbsp;facebook</a></div>
                         </div>
                     </section>
                 </section>
        </div>
